...
import org.easydarwin.action.AudioDecoder;
import org.easydarwin.action.UartHandle6804;
...
public class UartClient6804 {
    ...
    public UartClient6804(String ip, int port, UartHandle6804 socketDataCallback, UartHandle6804 socketStateCallback) {
        this.ip = ip;
        this.port = port;
