...
public class AudioClient1 {
    ...
    public AudioClient1(SocketDataCallback socketDataCallback, SocketStateCallback socketStateCallback) {
        ...
        public void run() {
            while (isRunning) {
                ...
                if (mSocket == null || input_s == null) {
                    Log.e(TAG, "AudioDecoder1: ============ 2222222222222222  " );
                    connect();
                }
    ...
    private boolean connect() {
        try {
            mSocket = new Socket();
            mSocket.connect(new InetSocketAddress(JniCallNative.getInstance().jniGetIP(), JniCallNative.getInstance().jniGetAudioClient1()), CONNECT_TIMEOUT);
            ...
            Log.e(TAG, "AudioDecoder1: ============ 3333333333333  " );
            start();
            ...
            Log.e(TAG, "AudioDecoder1: ============ 44444444444444  " );
            return false;
        }
        return true;
    }
